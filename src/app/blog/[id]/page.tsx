            ...
            <div className="max-w-7xl mx-auto px-5 md:px-12">
              ...
              <div className='flex md:flex-row flex-col mt-4 justify-between mb-7'>
                ...
                <div className='flex gap-3'>
                  <button onClick={() => { }} className='py-2 px-4 border border-gray-200 text-pr900 font-medium rounded-lg'>Salin link</button>
                  <ul className='flex gap-3'>
                    <li onClick={() => { }} className='flex items-center justify-center py-2 px-6 border border-gray-200 rounded-lg hover:cursor-pointer'>
