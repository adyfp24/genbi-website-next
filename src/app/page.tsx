    ...
    return (
        <div className='w-full'>
            ...
            <section id='hero-section' className="bg-pr50">
                ...
                <div className="pt-10 text-center md:text-center animate__animated animate__fadeIn">
                    <a href="" className="text-center mx-6 inline-flex items-center text-pr700 px-1 pr-1 md:pr-2 py-1 bg-pr100 rounded-3xl text-sm md:text-base"><span className='px-1 md:px-2 bg-pr50 rounded-2xl mr-1 md:mr-2 text-sm md:text-base'>Pendaftaran GenBI 2025 dibuka!</span> Daftar disini
                    ...
                    <p className="text-justify mb-6 md:mb-10 text-base mx-6 md:mx-36 text-pr700 lg:text-xl font-light sm:px-16 lg:px-50">Bersama GenBI Jember wujudkan mimpi dan kontribusi nyata untuk negeri. Ayo bergabung dengan komunitas
                    ...
                    <div className="mx-6 flex flex-col-reverse space-y-reverse space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        ...
                        <a href="#" className="text-center justify-center inline-flex text-lg py-4 px-7 sm:ms-4 font-semibold text-white focus:outline-none bg-pr500 rounded-lg border border-gray-200 hover:bg-pr700 hover:text-white focus:z-10 dark:hover:bg-gray-70">
                            Tentang GenBI
                        </a>
                    </div>
                </div>
                {/* </AnimationOnScroll> */}
                <div className='animate__animated animate__fadeInUp z-10 mt-6 md:mt-10 w-full flex justify-center items-center'>
            ...
            <section id='matrics-section' className='my-10'>
                <div className='max-w-7xl flex flex-wrap items-center justify-between mx-auto px-6 md:px-12'>
            ...
            <section id='benefit-section' className='mt-22'>
                <div className='max-w-7xl px-6 md:px-12 w-full h-full flex flex-col mx-auto mb-14 md:mb-28'>
