        ...
        <div className="max-w-7xl mx-auto md:px-12 px-5">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="w-full md:w-2/5 mb-8 md:mb-0">
              <div className="mb-8">
                <img className="w-34" src="/images/GenBI-Putih.png" alt="GenBI Logo" />
              </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-center md:text-left">© 2024 GenBI Jember. Supported by Kantor Perwakilan Bank Indonesia Jember</p>
