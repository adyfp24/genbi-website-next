...
const menuGroups = [
  ...
  },
  {
    ...
    menuItems: [
      {
        icon: (
          <RiArticleLine size={20} className="fill-gray dark:fill-white" />
        ),
        label: "Blog",
      ...
      {
        icon: (
          <BiTask size={20} className="fill-gray dark:fill-white" />
        ),
        label: "Program Kerja",
      ...
      {
        icon: (
          <MdOutlineRateReview size={20} className="fill-gray dark:fill-white" />
        ),
        label: "Testimoni",
      ...
      {
        icon: (
          <BsQuestionSquare size={18} className="fill-gray dark:fill-white" />
        ),
        label: "FAQ",
  ...
  },
  {
    ...
    menuItems: [
      {
        icon: (
          <PiNewspaperClipping size={20} className="fill-gray dark:fill-white" />
        ),
      ...
      {
        icon: (
          <HiOutlineBuildingOffice size={20} className="fill-gray dark:fill-white" />
        ),
        ...
        children: [
          { label: "UNEJ", route: "/" },
          { label: "POLIJE", route: "/" },
          { label: "UIN KHAS", route: "/" }
        ],
      },
      {
        icon: (
          <PiStudent size={20} className="fill-gray dark:fill-white" />
        ),
